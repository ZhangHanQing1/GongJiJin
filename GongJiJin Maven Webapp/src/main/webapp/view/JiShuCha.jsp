...
layui.use('table', function(){
  ...
  title:'比例变更记录表'
    ,elem: '#test'
    ,url:'KaiHu/selectJiShu'
    ,cols: [[
      {field:'bgzh', width:150, title: '变更编号', sort: true,width:150}
     ,{field:'dwmc2', width:150, title: '单位名称',width:150}
     ,{field:'xingming', width:150, title: '单位员工',width:150}
     ,{field:'xgqgzjs', width:150, title: '修改前个人基数', sort: true,width:150}
     ,{field:'grjcjs3', width:150, title: '现在个人基数',width:150}
