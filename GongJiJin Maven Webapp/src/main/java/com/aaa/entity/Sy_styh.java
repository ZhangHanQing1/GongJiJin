...
public class Sy_styh {
    ...
    public void setStyhdm(String styhdm) {
        this.styhdm = styhdm == null ? null : styhdm.trim();
    }
    ...
    public void setStyhmc(String styhmc) {
        this.styhmc = styhmc == null ? null : styhmc.trim();
    }
    ...
    public void setCbyw(String cbyw) {
        this.cbyw = cbyw == null ? null : cbyw.trim();
    }
    ...
    public void setYhjdh(String yhjdh) {
        this.yhjdh = yhjdh == null ? null : yhjdh.trim();
    }
